...
function scrollGrid() {
  ...
  cards.style.setProperty("--scrolldd", transY + "px");
...
//s'occupe de couper le son des vidéos quand on quitte la fenêtre (ne pas oublier d'ajouter une classe sur le iframe et &enablejsapi=1 à la fin du lien yt)
$('.close-button').click(function(){
	$('.youtube-video').each(function (index, element) {element.contentWindow.postMessage('{"event":"command","func":"' + 'stopVideo' + '","args":""}', '*');
})
});